...
def test_build_script():
    ...
    result = subprocess.run(
        [sys.executable, "build.py"], capture_output=True, text=True
    )
    ...
    executables = list(dist_dir.glob("QuantumOps*")) + list(
        dist_dir.glob("RosieVision-Error-Browser*")
    )
