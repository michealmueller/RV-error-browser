...
def test_fetch_builds_error(build_controller, build_manager, mock_progress_dialog, mock_message_box):
...
def test_download_build_success(build_controller, build_manager, mock_progress_dialog, mock_message_box):
...
def test_download_build_error(build_controller, build_manager, mock_progress_dialog, mock_message_box):
...
def test_upload_build_success(build_controller, build_manager, mock_progress_dialog, mock_message_box):
...
def test_upload_build_error(build_controller, build_manager, mock_progress_dialog, mock_message_box):
...
def test_progress_callback(build_controller, mock_progress_dialog):
    ...
    # Assert
    mock_progress_dialog.assert_called_once()
    mock_progress_dialog.return_value.set_progress.assert_called_once_with(progress, status)
