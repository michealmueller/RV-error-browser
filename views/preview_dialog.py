...
class PreviewDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        info = [
            ...
            (
                "Created",
                "2024-03-20 10:00:00",
            ),  # This should come from actual build data
    ...
    def install_build(self):
        ...
        try:
            ...
            QMessageBox.information(
                self, "Installation Started", f"Installing build {self.build_id}..."
            )
        except Exception as e:
            QMessageBox.critical(
                self, "Installation Failed", f"Failed to install build: {str(e)}"
            )
    ...
    def share_build(self):
        ...
        try:
            ...
            QMessageBox.information(
                self, "Share URL", f"Share URL copied to clipboard: {self.share_url}"
            )
        except Exception as e:
            QMessageBox.critical(
                self, "Share Failed", f"Failed to share build: {str(e)}"
            )
