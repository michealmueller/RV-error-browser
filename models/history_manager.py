...
class HistoryManager:
    ...
    def __init__(self, history_file: Optional[str] = None):
        ...
        self.history_file = history_file or str(
            Path.home() / ".quantumops" / "history.json"
        )
